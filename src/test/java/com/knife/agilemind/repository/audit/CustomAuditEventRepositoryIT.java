package com.knife.agilemind.repository.audit;

import com.knife.agilemind.AgileMindApp;
import com.knife.agilemind.config.Constants;
import com.knife.agilemind.config.audit.AuditEventConverter;
import com.knife.agilemind.domain.audit.PersistentAuditEvent;
...
import static com.knife.agilemind.repository.audit.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIT {
    ...
    public void setup() {
        customAuditEventRepository = new CustomAuditEventRepository(
            persistenceAuditEventRepository, auditEventConverter
        );
