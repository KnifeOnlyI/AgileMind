...
/**
 * Integration tests for {@link DefaultUserService}.
 */
...
public class UserServiceIT {
    ...
    @Test
    @Transactional
    public void testAssertThatUserMustExistToResetPassword() {
    ...
    @Test
    @Transactional
    public void testAssertThatOnlyActivatedUserCanRequestPasswordReset() {
    ...
    @Test
    @Transactional
    public void testAssertThatResetKeyMustNotBeOlderThan24Hours() {
    ...
    @Test
    @Transactional
    public void testAssertThatResetKeyMustBeValid() {
        Instant daysAgo = Instant.now().minus(25, ChronoUnit.HOURS);
        user.setActivated(true);
        user.setResetDate(daysAgo);
    ...
    @Test
    @Transactional
    public void testAssertThatUserCanResetPassword() {
    ...
    @Test
    @Transactional
    public void testAssertThatNotActivatedUsersWithNotNullActivationKeyCreatedBefore3DaysAreDeleted() {
    ...
    @Test
    @Transactional
    public void testAssertThatNotActivatedUsersWithNullActivationKeyCreatedBefore3DaysAreNotDeleted() {
        Instant now = Instant.now();
        when(dateTimeProvider.getNow()).thenReturn(Optional.of(now.minus(4, ChronoUnit.DAYS)));
        user.setActivated(false);
        UserEntity dbUser = userRepository.saveAndFlush(user);
    ...
    @Test
    @Transactional
    public void testAssertThatAnonymousUserIsNotGet() {
