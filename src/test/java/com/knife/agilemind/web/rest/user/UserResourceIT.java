...
import com.knife.agilemind.util.TestUtil;
...
public class UserResourceIT {
    ...
    /**
     * This repository is mocked in the com.knife.agilemind.repository.search test package.
     *
     * @see com.knife.agilemind.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @BeforeEach
    public void setup() {
        cacheManager.getCache(UserConstant.Cache.USERS_BY_LOGIN_CACHE).clear();
        cacheManager.getCache(UserConstant.Cache.USERS_BY_EMAIL_CACHE).clear();
    }
    ...
    @Test
    @Transactional
    public void testCreateUserWithExistingLogin() throws Exception {
    ...
    @Test
    @Transactional
    void testGetAllUsersSortedByParameters() throws Exception {
        // Initialize the database
        userRepository.saveAndFlush(user);
    ...
    public void testGetUser() throws Exception {
        ...
        assertThat(cacheManager.getCache(UserConstant.Cache.USERS_BY_LOGIN_CACHE).get(user.getLogin())).isNull();
        ...
        assertThat(cacheManager.getCache(UserConstant.Cache.USERS_BY_LOGIN_CACHE).get(user.getLogin())).isNotNull();
    }
    ...
    public void testUpdateUser() throws Exception {
        ...
        // Validate the User in the database
        assertPersistedUsers((List<UserEntity> users) -> {
    ...
    @Test
    @Transactional
    public void testUpdateUserExistingLogin() throws Exception {
        // Initialize the database
        userRepository.saveAndFlush(user);
        mockUserSearchRepository.save(user);
