package com.knife.agilemind.security.user;
...
public class DomainUserDetailsServiceIT {
    ...
    @Test
    public void testAssertThatUserCanBeFoundByLogin() {
    ...
    @Test
    public void testAssertThatUserCanBeFoundByLoginIgnoreCase() {
    ...
    @Test
    public void testAssertThatUserCanBeFoundByEmail() {
    ...
    @Test
    public void testAssertThatUserCanBeFoundByEmailIgnoreCase() {
        UserDetails userDetails = domainUserDetailsService.loadUserByUsername(
    ...
    @Test
    public void testAssertThatEmailIsPrioritizedOverLogin() {
    ...
    @Test
    public void testAssertThatUserNotActivatedExceptionIsThrownForNotActivatedUsers() {
